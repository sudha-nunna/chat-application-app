          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
            {[
              ...
              <button
                ...
                className="flex flex-col text-left p-4 rounded-xl border transition-all duration-200 group bg-surface-secondary hover:bg-white border-border-primary shadow-sm hover:shadow-md dark:bg-[#181818] dark:hover:bg-[#2f2f2f] dark:border-border-primary/40 dark:hover:border-border-primary"
              >
