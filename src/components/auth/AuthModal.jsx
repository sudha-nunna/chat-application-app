...
const AuthModal = ({ onAuthSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-8 bg-black/90 backdrop-blur-md">
      <div className="flex flex-col md:flex-row w-full max-w-sm sm:max-w-md md:max-w-4xl max-h-[90dvh] rounded-2xl md:rounded-[32px] border-none bg-[#0c0c0e] overflow-hidden shadow-[0_0_50px_-12px_rgba(99,102,241,0.25)] relative my-auto">
        {/* Top Hero Section (Desktop Only) */}
        <div className="hidden md:flex relative flex-col w-full md:w-1/2 p-6 md:p-10 justify-between bg-gradient-to-b from-[#141418] to-[#0c0c0e] border-none overflow-hidden shrink-0">
          ...
          <Link to="/" className="flex relative items-center gap-1">
            <img
        ...
        {/* Login Form Container (Centered on Mobile) */}
        <div className="w-full md:w-1/2 flex-1 flex flex-col justify-center bg-[#0e0e11] relative z-10 p-6 sm:p-8 md:p-10 shadow-[0_0_50px_-12px_rgba(99,102,241,0.25)] md:shadow-none overflow-y-auto custom-scrollbar">
          <div className="max-w-[340px] mx-auto w-full my-auto">
            ...
            <div className="space-y-3.5 mb-6 md:mb-8 bg-[#131317]/50 border-none p-4 rounded-2xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_0_20px_rgba(99,102,241,0.03)] hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_0_20px_rgba(99,102,241,0.08)] transition-shadow duration-300">
