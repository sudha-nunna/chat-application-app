...
const McpIntegrationsModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 dark:bg-black/80 backdrop-blur-md p-2.5 sm:p-4 animate-fadeIn touch-manipulation">
      <div className="relative w-full max-w-4xl rounded-2xl bg-white dark:bg-[#12131C] border border-gray-200 dark:border-white/10 shadow-2xl overflow-hidden flex flex-col h-[85vh] sm:h-[80vh] min-h-[460px] sm:min-h-[540px] max-h-[90vh] supports-[height:100dvh]:max-h-[88dvh] text-gray-900 dark:text-white transition-colors">
              ...
              <div id="custom-server-form" className="p-3 sm:p-3.5 rounded-xl bg-purple-500/5 dark:bg-purple-500/10 border border-purple-500/20 space-y-2.5 mt-3">
                ...
                <form onSubmit={handleAddCustomServer} className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      type="submit"
                      className="px-3 py-2 sm:py-1.5 rounded-lg bg-purple-600 text-white text-xs font-semibold hover:bg-purple-500 active:scale-95 transition cursor-pointer flex items-center justify-center gap-1 flex-1 sm:flex-none sm:w-auto min-h-[36px] sm:min-h-0 whitespace-nowrap"
                    >
