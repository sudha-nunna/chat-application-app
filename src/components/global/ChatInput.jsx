...
const ChatInput = ({ onSend, isGenerating, onStop }) => {
  ...
  return (
    <div className={`p-4 border-t ${
      "bg-interactive-base border-border-primary dark:border-border-primary/80"
    }`}>
      <div className="flex items-center gap-2 w-full max-w-3xl mx-auto">
        <input
          ...
          className={`flex-1 p-3 rounded-xl outline-none text-xs transition placeholder:text-text-secondary disabled:opacity-75 bg-white border border-border-primary focus:border-text-primary/30 text-text-primary dark:bg-[#1a1a1a] dark:text-white dark:border-transparent`}
        />
