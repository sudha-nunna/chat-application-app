          ...
          <div className="p-4 border-b border-border-primary/40 flex items-center gap-3 shrink-0 relative">
            ...
            {isProfileDropdownOpen && (
              ...
              >
                ...
                <button onClick={(e) => { e.stopPropagation(); setIsProfileDropdownOpen(false); setIsUsageModalOpen(true); }} className="w-full text-left px-4 py-2.5 font-medium hover:bg-surface-secondary dark:hover:bg-white/5 transition cursor-pointer flex items-center gap-3">
                  <FiActivity className="text-sm text-amber-400" /> Usage & Token Limits
                </button>
